...
import (
	...
	"github.com/takoha-cpp/cf-tool/cmd"
...
func main() {
	usage := `Codeforces Tool $%version%$ (cf). https://github.com/takoha-cpp/cf-tool
...
Examples:
  ...
  cf pull              Pull the latest codes of current problem into current
                       path.
  cf clone takoha-cpp      Clone all codes of takoha-cpp.
...
Script in template:
  ...
  $%path%$   Path to source file (Excluding $%full%$, e.g. "/home/takoha-cpp/")
